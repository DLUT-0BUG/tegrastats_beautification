/*
// File name: tx2_status.c  
// Author: Linwei Ye  
// Version: V2.1  
// Date: 2019-10-18  
// Description: This code can beautfy the output of cammand tegrastats on tx2.  
//  
// Modification: 1  
//    Modifier: Linwei Ye  
//    Date: 2019-10-20  
//    Description: Fix the missing temperature with sudo user.
// Modification: 2  
//    Modifier: Linwei Ye  
//    Date: 2019-10-20  
//    Description: Change the display style. 
// Modification: 3  
//    Modifier: Linwei Ye  
//    Date: 2019-12-02  
...
int CleanStatus( struct Status (*ptx2) ) 
{
    (*ptx2).RAM_used    = -1;
    (*ptx2).RAM_all     = -1;
    (*ptx2).lfb[0]      = -1;
    ...
    (*ptx2).MCPU_temp   = -1.0;  
    (*ptx2).PMIC_temp  = -1.0; 
    (*ptx2).Tboard_temp = -1.0;  
    (*ptx2).GPU_temp    = -1.0; 
    (*ptx2).BCPU_temp   = -1.0;  
    (*ptx2).thermal_temp= -1.0; 
    (*ptx2).Tdiode_temp = -1.0; 

    (*ptx2).VDD_SYS_GPU[0]  = -1; 
    (*ptx2).VDD_SYS_GPU[1]  = -1;
    (*ptx2).VDD_SYS_SOC[0]  = -1; 
    (*ptx2).VDD_SYS_SOC[1]  = -1; 
    (*ptx2).VDD_4V0_WIFI[0] = -1; 
    (*ptx2).VDD_4V0_WIFI[1] = -1;
    (*ptx2).VDD_IN[0]       = -1;  
    (*ptx2).VDD_IN[1]       = -1; 
    (*ptx2).VDD_SYS_CPU[0]  = -1; 
    (*ptx2).VDD_SYS_CPU[1]  = -1; 
    (*ptx2).VDD_SYS_DDR[0]  = -1; 
    (*ptx2).VDD_SYS_DDR[1]  = -1;
    return 0;
}
